...
plt.plot(fraction_of_nodes, size_max_component, label = 'Betweenness')
...
plt.plot(fraction_of_nodes, size_max_component, label = 'Eigenvector')
...
plt.plot(fraction_of_nodes, size_max_component, label = 'Degree')
...
plt.plot(fraction_of_nodes, size_max_component, label = 'Random')
