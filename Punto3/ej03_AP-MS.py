...
graph_nx = nx.read_edgelist('yeast_AP-MS.txt', create_using = nx.Graph())
...
plt.figure(1)
plt.plot(fraction_of_essentials, size_max_component, '.', markersize = 20, label = 'Essentials')
plt.figure(2)
plt.plot(fraction_of_essentials, size_max_component, '.', markersize = 20, label = 'Essentials')
...
vertex_name_remove = [item[0] for item in subgraph_centrality[:nodes_to_remove]]
